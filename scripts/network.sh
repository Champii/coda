...
screen -d -m -S daemon2 ./src/_build/default/app/cli/src/coda.exe daemon -bind-ip 127.0.0.1 -propose-key ./funded_wallet/genesis1 -peer 127.0.0.1:8303 -client-port 8401 -external-port 8402 -rest-port 8410 -config-directory /tmp/conf-8400
